...
\node (start) [startstop] {Starting client and setting up all Event Handler};
...
\node (endFailed) [startstop, xshift=2.5cm, right of=process2b] {Handle \mbox{Exception} and wait try to recover.};
